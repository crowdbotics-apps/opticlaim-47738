"""
Django settings for opticlaim_47738 project.
...
ROOT_URLCONF = 'opticlaim_47738.urls'
...
WSGI_APPLICATION = 'opticlaim_47738.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "opticlaim_47738 API",
    "DESCRIPTION": "API documentation for opticlaim_47738 App",
    "VERSION": "v1",
}
